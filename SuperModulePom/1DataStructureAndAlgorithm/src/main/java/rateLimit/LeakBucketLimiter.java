...
public class LeakBucketLimiter {
    ...
    public static synchronized boolean isLimit(long taskId, int turn) {
        ...
        if (water.get() == 0) {
            ...
            water.addAndGet(1);
            System.out.println(taskId + "第"+water.get() +"请求通过: " + System.currentTimeMillis());
            return false;
        }
        // 执行漏水
        ...
        if ((water.get()) < capacity) {
            ...
            return false;
             ...
             System.out.println(taskId + "第"+water.get() +"请求被限流  : " + System.currentTimeMillis());
            // 水满，拒绝加水， 限流
            return true;
        }
